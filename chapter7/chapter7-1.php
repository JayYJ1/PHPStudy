<?php
    ...
    //Object
    $p1 = new Person();//Person이라는 클래스로부터 p라는 객체 생성

    $p1->name="James"; //객체 p의 name 프로퍼티
    $p1->nation="South Korea"; //객체 p의 nation 프로퍼티
    $p1->gender = "Male"; //객체 p의 gender 프로퍼티
    $p1->birth = 2000; //객체 p의 birth 프로퍼티
    $p1->peronnel(); //객체 p의 personnel 메소드 호출
?>
<?php
